...
'''
valor = str(input('Informe o peso total: ')).replace(',', '.')
peso = float(valor)
...
if peso > limite:
    ...
    multa = excedente * multaporquilo
    print(f'O peso informado execedeu em {excedente:.2f}kg, sendo necessário o pagamento da multa no valor'
          f' de R$ {multa:.2f} por kilo excedido.')
else:
    print('Não há necessidade de pagamento da multa.')
